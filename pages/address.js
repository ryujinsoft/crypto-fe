                    ...
                    >
                        ...
                        <GridItem colSpan={4} >
                            ...
                            <div className={styles.separo}>
                                ...
                                <Text mt={2} mb={2} fontSize="md"> Address </Text>
                                <Input placeholder="Email" size="lg"></Input>
                                <Text mt={4} mb={2} fontSize="md"> City </Text>
                                <Input placeholder="Full Name" size="lg"></Input>
                                <Text mt={4} mb={2} fontSize="md"> State / Province </Text>
                                <Input placeholder="Date Of Birth" size="lg"></Input>
                                <Text mt={4} mb={2} fontSize="md"> Zip code / Postal code </Text>
                                <Input placeholder="Phone Number" size="lg"></Input>
                                <Text mt={2} mb={2} fontSize="md"> Country </Text>
                                <Input placeholder="Email" size="lg"></Input>
